      ...
      <footer className="text-center text-sm text-white flex flex-col justify-center items-center p-2">
        <span>
          ...
          <span
            ...
            onClick={() => window.open('https://github.com/Arzzam', '_blank')}
          >
            Arzzam
          </span>
        </span>
        <div className="flex items-center justify-center" >
          <span className="text-orange-300">Give a ⭐ on GitHub if you liked it!</span>
          <svg
            ...
            className='ml-1 text-white hover:text-orange-400 w-4 h-4 cursor-pointer'
          >
